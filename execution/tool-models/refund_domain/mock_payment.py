...
# Ensure execution/tool-models directory is in sys.path
_tool_models_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
if _tool_models_dir not in sys.path:
    sys.path.insert(0, _tool_models_dir)

from base import ToolModel, UnsupportedFaultException, register
